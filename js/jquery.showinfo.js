     ...
     $.fn.airtimeShowSchedule = function (options) {
         ...
         return this.each(function () {
             ...
             function updateWidget() {
                 ...
                 tableString = "";
                 tableString += "<h3><span class='label label-primary col-xs-12'>Honduras UTC-06:00</span></h3> <table class='table table-bordered'>" +
                     "<tbody><th>Hora</th><th class='programa'>Programa</th>";
         ...
         return this.each(function () {
             ...
             function updateWidget() {
                 ...
                 obj.append(
                     ...
                     "<tbody><th>Tiempo Elapsado</th><th>Tiempo Restante</th>" + "<tr><td align='center'><span class='time1'>" + timeElapsed + "</span></td><td align='center'><span class='time1 remainingTime'>" + timeRemaining + "</span></td></tr></tbody></table></div>" +
                     "<div class=''><ul class='widget now-playing-bar list-group'>" +
                     "<li class='current track-metadata list-group-item active'>" + options.text.current + ":</br>" + sd.currentTrack.getTitle() + "</li>" +
                     "<li class='next track-metadata list-group-item'>" + options.text.next + ":</br>" + sd.nextTrack.getTitle() + "</span></li>" +
                     "</ul></div>");
             }
